...
from .metric import ComputeMetrics, ComputeLabelMetrics,compute_accuracy, eval_logit_processor
...
def run_sft(
    ...
    if data_args.val_dataset:
        ...
        trainer = CustomSeq2SeqTrainer(
            ...
            callbacks=callbacks,
            compute_metrics=ComputeMetrics(tokenizer) if training_args.predict_with_generate else ComputeLabelMetrics(tokenizer),
